        ...
        <div className="py-12 grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-bold">Vargas Tax Preparation</h3>
            </div>
            <p className="text-primary-foreground/80 mb-6 leading-relaxed">
              Professional tax preparation services with over 15 years of experience. 
              Maximizing refunds and ensuring compliance for individuals and businesses.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-primary-foreground font-medium">info@vargastax.com</p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-primary-foreground font-medium">123 Main Street, Suite 200</p>
                  <p className="text-primary-foreground/60 text-sm">Downtown Financial District</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-primary-foreground/20 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-primary-foreground/80 text-sm mb-4 md:mb-0">
              © {currentYear} Vargas Tax Preparation Services. All rights reserved.
            </div>
