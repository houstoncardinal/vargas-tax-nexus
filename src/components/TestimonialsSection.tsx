  ...
  const testimonials = [
    {
      ...
      rating: 5,
      content: "Maria and her team are absolutely fantastic! They found deductions I never knew existed and got me a much larger refund than expected. Professional, thorough, and trustworthy. They've been handling both my personal and business taxes for 3 years now.",
      savings: "$4,200",
    ...
    },
    {
      ...
      rating: 5,
      content: "As a real estate investor with multiple properties, my taxes are complex. Vargas Tax not only handles everything perfectly but also provides year-round tax planning advice that has saved me thousands. Their expertise is unmatched.",
      savings: "$7,500",
    ...
    },
    {
      ...
      rating: 5,
      content: "After retirement, my tax situation became more complex with pensions and investments. Maria explained everything clearly and made sure I wasn't overpaying. Their patience and expertise gave me peace of mind.",
      savings: "$1,900",
